      ...
      <section className="relative flex items-center justify-center min-h-[60vh] md:min-h-[70vh] overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <p className="mt-4 text-lg md:text-xl text-white/80 max-w-2xl mx-auto">
            {isJa
              ? "オープンイノベーションのための検証可能な未来を、一緒に築きましょう。"
              : "Build a verifiable future for open innovation, together."}
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {positions.map((position) => (
              <Link
                ...
                className="group block rounded-lg border border-border bg-white p-6 transition-all hover:shadow-lg hover:border-gray-300"
              >
