...
import { CORPORATE_SPONSORS, INDIVIDUAL_SUPPORTERS, PREMIUM_SPONSORS } from "@/app/donate/constants";
...
const ContributionSupportersSection = () => {
  ...
  const premiumSponsorTitle = t("supportersSection.premiumSponsorTitle");
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="rounded-xl px-6 py-12 md:px-14 md:py-14 bg-white shadow-sm ring-1 ring-gray-100">
          <div className="grid grid-cols-1 gap-12 md:gap-14">
            {PREMIUM_SPONSORS.length > 0 && (
              <div>
                <h3 className="text-xl md:text-2xl font-bold leading-tight mb-8">{premiumSponsorTitle}</h3>
